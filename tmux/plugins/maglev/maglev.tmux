...
apply_theme() {
    ...
    window_status_bg="#151515" # dark gray
    ...
    window_status_current_fg="#151515" # black
    ...
    status_right="︎阮#{music_status} #{artist}: #{track} 阮 #[fg=$time_date_fg,nobold]$right_separator %R $right_separator %a %d %b #[fg=$host_bg]$right_separator_black#[fg=$host_fg,bg=$host_bg] #{battery_icon}  #{battery_percentage} $right_separator CPU #{cpu_percentage}"
